...
urlpatterns = [
    ...
    path('api/resumes/<int:resume_id>/ats-score/', ai_views.ATSScoreView.as_view(), name='ats_score'),
    path('api/chat/', ai_views.ChatView.as_view(), name='chat'),
    path('api/salary/calculate/', ai_views.SalaryCalculatorView.as_view(), name='salary_calculate'),
    path('api/salary/offer/', ai_views.SalaryOfferView.as_view(), name='salary_offer'),
    path('api/salary/titles/', ai_views.SalaryTitlesView.as_view(), name='salary_titles'),
    path('api/interview-prep/generate/', ai_views.InterviewPrepView.as_view(), name='interview_prep_generate'),
    path('api/email-template/generate/', ai_views.EmailTemplateView.as_view(), name='email_template_generate'),
    path('api/linkedin/optimize/', ai_views.LinkedInOptimizeView.as_view(), name='linkedin_optimize'),
    ...
    path('resumes/<int:resume_id>/ats-score/', views.ats_score_page, name='ats_score_page'),
    path('interview-prep/', views.interview_prep_page, name='interview_prep_page'),
    path('interview-prep/<int:resume_id>/', views.interview_prep_page, name='interview_prep_page_resume'),
    path('email-templates/', views.email_template_page, name='email_template_page'),
    path('email-templates/<int:resume_id>/', views.email_template_page, name='email_template_page_resume'),
    path('linkedin-optimizer/', views.linkedin_optimizer_page, name='linkedin_optimizer_page'),
    path('salary-calculator/', views.salary_calculator_page, name='salary_calculator'),
